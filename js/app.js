(() => {
  ...
  function ie({ swiper: e, extendParams: t, on: s, emit: i }) {
    ...
    function u() {
      e.params.autoplay.disableOnInteraction ? l() : (i("autoplayPause"), d()),
        ["transitionend", "webkitTransitionEnd"].forEach((t) => {
          e.$wrapperEl[0].removeEventListener(t, p);
        });
    }
      ...
      document.querySelector(".about__slider") &&
        new te(".about__slider", {
          ...
          breakpoints: {
            ...
            700: { slidesPerView: 2, spaceBetween: 34 },
          },
          on: {},
        }),
      de();
  });
  const oe = window.matchMedia("(min-width: 479.98px)");
  let le;
  const de = function () {
    !0 === oe.matches
      ? void 0 !== le && le.destroy(!0, !0)
      : !1 === oe.matches &&
        document.querySelector(".work-page__slider") &&
        (le = new te(".work-page__slider", {
          modules: [ie],
          slidesPerView: 1,
          spaceBetween: 15,
